...
void ospf_send() {
  ...
  while (true) {
    ...
    ospf_hel->DesignatedRouter.s_addr = inet_addr("192.168.36.1");
    ospf_hel->BackupDesignatedRouter.s_addr = inet_addr("192.168.36.2");
    ospf_hel->Neighbor.s_addr = inet_addr("192.168.36.2");
